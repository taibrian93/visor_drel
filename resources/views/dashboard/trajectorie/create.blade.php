            ...
            <div class="card">
                ...
                <div class="card-body">
                    <x-table>
                        ...
                        @slot('tbody')
                            @foreach ($trajectories as $key => $value)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>{{ Helper::getDescriptionPopulationCenter($value->puntoPartida) }}</td>
                                    <td>{{ Helper::getDescriptionPopulationCenter($value->puntoLlegada) }}</td>
                                    <td>{{ $value->distancia.' KM' }}</td>
                                    <td></td>
                                </tr>
                            @endforeach
                        @endslot
