        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card card-outline card-primary collapsed-card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        Seleccionar <b>Centro Poblados</b> por Provincia
                                    </h4>
                        ...
                        <div class="col-md-6">
                            <div class="card card-outline card-primary collapsed-card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        Seleccionar <b>Colegios</b> por Provincia
                                    </h4>
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fas fa-plus"></i>
                                ...
                                <div class="card-body pb-0">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input id="checkCollegeMaynas" type="checkbox" class="form-check-input checkColleges" value="1">
                                                    <label for="checkCollegeMaynas" class="form-check-label">Provincia Maynas</label>
                                                </div>
                                                <div class="form-check">
                                                    <input id="checkCollegeAltoAmazonas" type="checkbox" class="form-check-input checkColleges" value="2">
                                                    <label for="checkCollegeAltoAmazonas" class="form-check-label">Provincia Alto Amazonas</label>
                                                </div>
                                                <div class="form-check">
                                                    <input id="checkCollegeLoreto" type="checkbox" class="form-check-input checkColleges" value="3">
                                                    <label for="checkCollegeLoreto" class="form-check-label">Provincia Loreto</label>
                                                </div>
                                                <div class="form-check">
                                                    <input id="checkCollegeMariscal" type="checkbox" class="form-check-input checkColleges" value="4">
                                                    <label for="checkCollegeMariscal" class="form-check-label">Provincia Masriscal Ramon Castilla</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input id="checkCollegeRequena" type="checkbox" class="form-check-input checkColleges" value="5">
                                                    <label for="checkCollegeRequena" class="form-check-label">Provincia Requena</label>
                                                </div>
                                                <div class="form-check">
                                                    <input id="checkCollegeUcayali" type="checkbox" class="form-check-input checkColleges" value="6">
                                                    <label for="checkCollegeUcayali" class="form-check-label">Provincia Ucayali</label>
                                                </div>
                                                <div class="form-check">
                                                    <input id="checkCollegeDatem" type="checkbox" class="form-check-input checkColleges" value="7">
                                                    <label for="checkCollegeDatem" class="form-check-label">Provincia Datem del Marañon</label>
                                                </div>
                                                <div class="form-check">
                                                    <input id="checkCollegePutumayo" type="checkbox" class="form-check-input checkColleges" value="8">
                                                    <label for="checkCollegePutumayo" class="form-check-label">Provincia Putumayo</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group">
                                <select name="" id="" class="form-control selectTypeSearch" style="max-width: 20vw;">
                                    <option value="1">Nombre Centro Educativo</option>
                                    <option value="2">Codigo Modular</option>
                                    <option value="3">Codigo Local</option>
                                    <option value="4">Nombre Centro Poblado</option>
                                    <option value="5">Cod. Ubigeo Centro Poblado</option>
                                </select>
                    ...
                    <div class="mt-4" id="visor">

                    </div>
                    {{-- @livewire('visor.visor') --}}
                </div>
            </div>
        </div>
    </div>
